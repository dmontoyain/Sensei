...
class Api42:
	#	Filter Lists
	_excludedProjectNames = [ 'harassment_policy', 'First Internship', 'Savoir Relier', 'ft_debut', 'Piscine Interview', 'Piscine CPP', 'Piscine PHP', 'HackerRank University CodeSprint 4', 'Check Your Dorms', 'Hercules']
